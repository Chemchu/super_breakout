...
use crate::{
    ...
    slots::{
        dispatch_slot1, dispatch_slot2, dispatch_slot3, dispatch_slot4, dispatch_slot5,
        dispatch_slot6, dispatch_slot7, dispatch_slot8,
    },
};
...
impl Plugin for InputPlugin {
    fn build(&self, app: &mut App) {
        app.add_input_context::<InputManager>()
            .add_observer(dispatch_slot1)
